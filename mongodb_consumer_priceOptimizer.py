...
class DynamicPricingModel:
    ...
    def recommend_price(self, asin, brand):
        ...
        recommended_price = avg_brand_price * (1 + demand_factor / 100)
    ...
    for message in consumer:
        ...
        if 'asin' in data and 'also_buy' in data and 'price' in data and 'brand' in data:
            ...
            pricing_collection.insert_one({
                ...
                "demand_factor": model.product_demand.get(data['asin'], 0),
                "average_brand_price": np.mean(model.brand_pricing.get(data['brand'], []))
            })
